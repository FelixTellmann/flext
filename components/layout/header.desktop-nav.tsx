            ...
            return (
              ...
              >
                <Link
                  href={link.href}
                  className={clsx(
                    "relative z-10 flex rounded-md border-2 border-transparent py-1.5 px-4 text-gray-500 transition-all hfa:text-gray-900 d:text-gray-300 d:hfa:text-gray-50",
                    isActive &&
