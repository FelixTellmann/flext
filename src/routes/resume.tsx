...
const ProfilePic = "/images/about/resume-profile.jpg";
...
function ResumePage() {
  ...
  return (
    <table className="margin-0 padding-0 print:!table relative block min-h-screen appearance-none border-none text-gray-900 [&_td]:p-0">
      <thead className="print:!table-header-group hidden w-full">
        <tr>
          <th className="flex w-[1024px] pb-4 text-left font-normal">
            <header className="">
              <h1 className="font-extrabold text-4xl tracking-tight">{CV.name}</h1>
            ...
            <div className="spacing-0 mt-1 mt-auto ml-auto flex-1 items-end justify-end text-right text-[15px] text-gray-500">
              <div>
      ...
      <tfoot className="print:!table-footer-group fixed inset-x-0 bottom-0 hidden w-full text-center">
        <tr>
          <th>
            <small className="absolute bottom-0 left-1/2 -translate-x-1/2 pt-3 pb-1 font-medium text-[13px] text-gray-400 tracking-tight">
            ...
            <article className="print:!flex print:!py-0 print:!pl-24 print:[&_*]:![-webkit-print-color-adjust:exact] print:[&_*]:![print-color-adjust:exact] relative mx-auto mb-16 grid max-w-6xl gap-12 px-4 py-16 md:px-8 lg:grid-cols-[1fr_200px]">
              <main className="spacing-10 snap-y snap-normal">
                <ResumeSection title="Intro" className="print:!max-w-3xl break-inside-avoid">
                  <p className="print:!-ml-24 print:!max-w-3xl print:!text-base d:text-gray-300 d:text-gray-300 text-[15px] text-gray-500 leading-relaxed">
                    {CV.intro}
                  </p>
                </ResumeSection>
                ...
                <ResumeSection
                  title="Experience"
                  className={clsx(!CV.experience.filter(({ type }) => type.includes(filter) || filter === "all").length && "!hidden")}
                >
                ...
                <ResumeSection className="break-inside-avoid" title="Capabilities">
                  <div className="spacing-8 print:!-ml-24 print:!spacing-3">
                    ...
                    <section className="spacing-1 print:!grid print:!max-w-3xl print:!grid-cols-[140px_1fr] relative max-w-prose">
                      ...
                      <p className="print:!mt-0 d:text-gray-300/80 text-gray-500 text-sm d:marker:text-gray-600 marker:text-gray-400">
                        {CV.capabilities.librariesFrameworks.map((language, index) => language.name).join(", ")}
                      </p>
                    </section>
                    <section className="spacing-1 print:!grid print:!max-w-3xl print:!grid-cols-[140px_1fr] relative max-w-prose">
                      <h3 className="spacing-1 items-baseline text-sm tracking-tight">
                      ...
                      <p className="print:!mt-0 d:text-gray-300/80 text-gray-500 text-sm d:marker:text-gray-600 marker:text-gray-400">
                        {CV.capabilities.serviceProviders.map((language, index) => language.name).join(", ")}
                      </p>
                    </section>
                    <section className="spacing-1 print:!grid print:!max-w-3xl print:!grid-cols-[140px_1fr] relative max-w-prose">
                      <h3 className="spacing-1 items-baseline text-sm tracking-tight">
                ...
                >
                  <div className="spacing-6 print:!-ml-24">
                    ...
                    {["all", "restaurant"].includes(filter) ? (
                      <section className="spacing-1 relative max-w-prose">
                        <h3 className="spacing-1 items-baseline text-sm tracking-tight">
                          <strong className="font-bold d:text-gray-100 text-[17px] text-gray-900">Other</strong>{" "}
                        </h3>
                        <ul className="list-outside list-disc pl-4 d:text-gray-300/80 text-gray-500 text-sm d:marker:text-gray-600 marker:text-gray-400">
