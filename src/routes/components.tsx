        ...
        <aside className="w-64">
          <nav className="sticky top-20 spacing-1">
            <h3 className="mb-4 font-semibold tracking-tight text-gray-200">
              <span className="inline-flex select-none border-b-2 border-b-gray-400 pb-2 pr-4">Global Components</span>
            </h3>
            <Link href="/components/headings" className="group flex items-center gap-3 whitespace-nowrap py-1">
              ...
              <span className="text-sm font-medium text-gray-400 transition-colors duration-100 group-hover:text-white">Headings</span>
            </Link>
            <Link href="/components/headings" className="group flex items-center gap-3 whitespace-nowrap py-1">
              ...
              <span className="text-sm font-medium text-gray-400 transition-colors duration-100 group-hover:text-white">Paragraphs</span>
            </Link>
          </nav>
        </aside>
