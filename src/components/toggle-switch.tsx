...
export const ToggleSwitch: FC<ToggleSwitchProps> = ({ enabled, setEnabled, enabledIcon, disabledIcon }) => {
    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{
            transform: enabled ? `translateX(calc(${switchRef.current?.clientWidth}px - 100% - 4px))` : "translateX(0px)",
          }}
        >
          <figure
            className={clsx(
