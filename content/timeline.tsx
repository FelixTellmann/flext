import { CakeIcon, SignalIcon } from "@heroicons/react/24/solid";

export const TIMELINE = [
  {
    date: "1986-01-08",
    icon: ({ className }) => <CakeIcon className={className} />,
    heading: "Born",
  ...
  },
  {
    date: "1999-05-01",
    icon: ({ className }) => <SignalIcon className={className} />,
    heading: "Gaming & Web dev",
    description:
      "I got into Gaming 🕹, Lan Parties and build my first websites using MS FrontPage 98. Anyone remembers Frames? 🙃",
  },
  {
    date: "1999-05-01",
    icon: ({ className }) => <SignalIcon className={className} />,
